...
class TranslationsAr extends Translations {
	...
	@override String get autoPlay => 'تمكين التشغيل التلقائي للفيديو';
	@override String get autoPlayDesc => 'تشغيل مقاطع الفيديو تلقائيًا عند التمرير خلال خلاصتك.';
	@override String get copyText => 'نسخ النص';
	@override String get errorSelectingMedia => 'حدث خطأ أثناء تحديد الوسائط';
	@override String get fetchingUserOutboxRelays => 'جلب مرحلات الصادر للمستخدم';
	@override String get noMediaSelected => 'لم يتم تحديد أي وسائط';
	@override String get memoOptional => 'مذكرة (اختياري)';
	@override String get payOrSwap => 'دفع أو مبادلة';
	@override String get payOrSwapDesc => 'دفع فاتورة Lightning أو عنوان أو مبادلة إلى محفظة';
	@override String get claimed => 'تم المطالبة به';
	@override String get cashuWallet => 'محفظة Cashu';
	@override String get walletBalance => 'رصيد المحفظة';
	@override String get mintBalance => 'رصيد Mint';
	@override String get mintHasBeenCopied => 'تم نسخ Mint';
	@override String get swap => 'مبادلة';
	@override String get swapTokens => 'مبادلة الرموز';
	@override String get swapTokensDesc => 'مبادلة الرموز بين Mints';
	@override String get swapFrom => 'مبادلة من';
	@override String get swapTo => 'مبادلة إلى';
	@override String get selectMint => 'اختر Mint';
	@override String get amount => 'الكمية';
	@override String get cashuHistory => 'سجل Cashu';
	@override String get history => 'سجل';
	...
	@override String get swapModesWallet => 'محفظة';
	@override String get redeemEcash => 'استرداد eCash';
	@override String get deposit => 'إيداع';
	@override String get redeemEcashDesc => 'استرداد رموز ecash إلى محفظتك';
	@override String get depositDesc => 'سك رموز ecash جديدة عن طريق إيداع sats';
	@override String get pasteToken => 'لصق الرمز';
	@override String get scanToken => 'مسح';
	@override String get tokenDetails => 'تفاصيل الرمز';
	@override String get issuingMint => 'Mint المُصدر';
	@override String get proofs => 'إثباتات';
	@override String get redeemToken => 'استرداد الرمز';
	@override String get invalidToken => 'رمز غير صالح';
	@override String get tokenRedeemed => 'تم استرداد الرمز بنجاح';
	@override String get noMintsAvailable => 'لا توجد Mints متاحة';
	@override String get currencies => 'عملات';
	@override String get nuts => 'NUTs';
	@override String get errorUpdatingMint => 'حدث خطأ أثناء تحديث قائمة Mints';
	@override String get active => 'نشط';
	@override String get inactive => 'غير نشط';
	@override String get addCashuWallet => 'أضف محفظة Cashu وابدأ في إرسال واستلام Ecash عبر nostr.';
	@override String get mintUrl => 'رابط Mint';
	@override String get mintUnavailable => 'Mint الذي تحاول إضافته غير متاح';
	@override String get inactiveMints => 'Mints غير نشطة';
	@override String get inactiveMintsDesc => 'Mints غير النشطة هي Mints غير المدرجة في محفظتك ولكنها لا تزال تحتوي على ecash.';
	@override String get errorAddingMint => 'حدث خطأ أثناء إضافة Mint';
	@override String get restoreWallet => 'استعادة المحفظة';
	@override String get restoreWalletDesc => 'استعادة إثباتات محفظتك في هذا Mint لحفظها على NOSTR';
	@override String get seedPhraseLocallyOnly => 'يتم استخدام عبارة الاسترداد الخاصة بك محليًا فقط لاشتقاق مفاتيح محفظتك.';
	@override String get proofsRestored => 'تم استعادة الإثباتات';
	@override String get noProofsFound => 'لم يتم العثور على إثباتات';
	@override String get errorRestoringProofs => 'حدث خطأ أثناء استعادة الإثباتات';
	@override String get invalidAmount => 'كمية غير صالحة';
	@override String get broadcastingNew => 'بث رموز جديدة';
	@override String get broadcastingSpent => 'بث سجل الإنفاق';
	@override String get finalizing => 'جاري الانتهاء';
	@override String get selectingTokens => 'اختيار الرموز';
	@override String get requestingMeltQuote => 'طلب عرض melt';
	@override String get melting => 'جاري الـ Melting';
	@override String get requestingMintQuote => 'طلب عرض mint';
	@override String get minting => 'جاري الـ Minting';
	@override String get cantSwapWithWallet => 'لا يمكن المبادلة مباشرة مع وجهة محفظة lightning. يرجى اختيار mint للمبادلة بين mints أو استخدام حقل \'إلى\' لاختيار وجهة محفظة.';
	@override String get selectDestination => 'اختر وجهة';
	@override String get internalWallets => 'محافظ داخلية';
	@override String get verifyToken => 'التحقق من الرمز';
	@override String get memo => 'مذكرة';
	@override String get payingInvoice => 'دفع الفاتورة';
	@override String get addMint => 'إضافة Mint';
	@override String get gettingMintInfo => 'الحصول على معلومات Mint';
	@override String get generatingInvoice => 'إنشاء فاتورة';
	@override String get checkPaymentStatus => 'التحقق من حالة الدفع';
	@override String get depositSuccess => 'تم الإيداع بنجاح';
	@override String get sendEcash => 'إرسال eCash';
	@override String get sendEcashDesc => 'إنشاء ومشاركة رمز Cashu';
	@override String get insufficientFunds => 'رصيد غير كافٍ';
	@override String get copyToken => 'نسخ الرمز';
	@override String get shareToken => 'مشاركة الرمز';
	@override String get createToken => 'إنشاء رمز';
	@override String get eCash => 'eCash';
	@override String get noTokenCanBeFound => 'لا يمكن العثور على رمز';
	@override String get alreadySpent => 'تم إنفاقه بالفعل';
	@override String get checkStatus => 'التحقق من الحالة';
	@override String get deleteToken => 'حذف الرمز';
	@override String get deleteTokenDesc => 'هل أنت متأكد أنك تريد حذف هذا الرمز؟ لا يمكن التراجع عن هذا الإجراء.';
	@override String get nutZap => 'Nut Zap';
	@override String get nutZapDesc => 'إرسال sats إلى مستخدم عبر Nostr';
	@override String get syncData => 'مزامنة';
	@override String get checkingTokensValidity => 'التحقق من صلاحية الرموز';
	@override String get nutZapSent => 'تم إرسال Nut Zap';
	@override String get noNutzapsFound => 'لم يتم العثور على NutZaps';
	@override String get noNutzapsFoundDesc => 'لم تتلق أي NutZaps بعد.';
	@override String get swapSuccessful => 'تمت المبادلة بنجاح';
	@override String get nutzapClaimedSuccessful => 'تم المطالبة بـ NutZap بنجاح';
	@override String get initializing => 'جاري التهيئة';
	@override String userNutZappedYou({required Object name, required Object number}) => '${name} أرسل لك nut zap بقيمة ${number} sats';
	@override String get noteDeletedSuccessfully => 'تم حذف الملاحظة بنجاح';
	@override String get ecashCreated => 'تم إنشاء eCash';
	@override String get toMint => 'إلى Mint';
	@override String get toLightning => 'إلى Lightning';
	@override String get payOrWithdraw => 'دفع أو سحب';
...
extension on TranslationsAr {
	...
	dynamic _flatMapFunction$2(String path) {
		return switch (path) {
			...
			'autoPlay' => 'تمكين التشغيل التلقائي للفيديو',
			'autoPlayDesc' => 'تشغيل مقاطع الفيديو تلقائيًا عند التمرير خلال خلاصتك.',
			'copyText' => 'نسخ النص',
			'errorSelectingMedia' => 'حدث خطأ أثناء تحديد الوسائط',
			'fetchingUserOutboxRelays' => 'جلب مرحلات الصادر للمستخدم',
			'noMediaSelected' => 'لم يتم تحديد أي وسائط',
			'memoOptional' => 'مذكرة (اختياري)',
			'payOrSwap' => 'دفع أو مبادلة',
			'payOrSwapDesc' => 'دفع فاتورة Lightning أو عنوان أو مبادلة إلى محفظة',
			'claimed' => 'تم المطالبة به',
			'cashuWallet' => 'محفظة Cashu',
			'walletBalance' => 'رصيد المحفظة',
			'mintBalance' => 'رصيد Mint',
			'mintHasBeenCopied' => 'تم نسخ Mint',
			'swap' => 'مبادلة',
			'swapTokens' => 'مبادلة الرموز',
			'swapTokensDesc' => 'مبادلة الرموز بين Mints',
			'swapFrom' => 'مبادلة من',
			'swapTo' => 'مبادلة إلى',
			'selectMint' => 'اختر Mint',
			'amount' => 'الكمية',
			'cashuHistory' => 'سجل Cashu',
			'history' => 'سجل',
			'nutzaps' => 'Nutzaps',
			'recommended' => 'موصى به',
			'mints' => 'Mints',
			'swapModesMint' => 'Mint',
			'swapModesWallet' => 'محفظة',
			'redeemEcash' => 'استرداد eCash',
			'deposit' => 'إيداع',
			'redeemEcashDesc' => 'استرداد رموز ecash إلى محفظتك',
			'depositDesc' => 'سك رموز ecash جديدة عن طريق إيداع sats',
			'pasteToken' => 'لصق الرمز',
			'scanToken' => 'مسح',
			'tokenDetails' => 'تفاصيل الرمز',
			'issuingMint' => 'Mint المُصدر',
			'proofs' => 'إثباتات',
			'redeemToken' => 'استرداد الرمز',
			'invalidToken' => 'رمز غير صالح',
			'tokenRedeemed' => 'تم استرداد الرمز بنجاح',
			'noMintsAvailable' => 'لا توجد Mints متاحة',
			'currencies' => 'عملات',
			'nuts' => 'NUTs',
			'errorUpdatingMint' => 'حدث خطأ أثناء تحديث قائمة Mints',
			'active' => 'نشط',
			'inactive' => 'غير نشط',
			'addCashuWallet' => 'أضف محفظة Cashu وابدأ في إرسال واستلام Ecash عبر nostr.',
			'mintUrl' => 'رابط Mint',
			'mintUnavailable' => 'Mint الذي تحاول إضافته غير متاح',
			'inactiveMints' => 'Mints غير نشطة',
			'inactiveMintsDesc' => 'Mints غير النشطة هي Mints غير المدرجة في محفظتك ولكنها لا تزال تحتوي على ecash.',
			'errorAddingMint' => 'حدث خطأ أثناء إضافة Mint',
			...
			'broadcastingNew' => 'بث رموز جديدة',
			'broadcastingSpent' => 'بث سجل الإنفاق',
	...
	dynamic _flatMapFunction$3(String path) {
		return switch (path) {
			...
			'sendEcashDesc' => 'إنشاء ومشاركة رمز Cashu',
			'insufficientFunds' => 'رصيد غير كافٍ',
			'copyToken' => 'نسخ الرمز',
			'shareToken' => 'مشاركة الرمز',
			'createToken' => 'إنشاء رمز',
			'eCash' => 'eCash',
			'noTokenCanBeFound' => 'لا يمكن العثور على رمز',
			'alreadySpent' => 'تم إنفاقه بالفعل',
			'checkStatus' => 'التحقق من الحالة',
			'deleteToken' => 'حذف الرمز',
			'deleteTokenDesc' => 'هل أنت متأكد أنك تريد حذف هذا الرمز؟ لا يمكن التراجع عن هذا الإجراء.',
			'nutZap' => 'Nut Zap',
			'nutZapDesc' => 'إرسال sats إلى مستخدم عبر Nostr',
			'syncData' => 'مزامنة',
			'checkingTokensValidity' => 'التحقق من صلاحية الرموز',
			'nutZapSent' => 'تم إرسال Nut Zap',
			'noNutzapsFound' => 'لم يتم العثور على NutZaps',
			'noNutzapsFoundDesc' => 'لم تتلق أي NutZaps بعد.',
			'swapSuccessful' => 'تمت المبادلة بنجاح',
			'nutzapClaimedSuccessful' => 'تم المطالبة بـ NutZap بنجاح',
			'initializing' => 'جاري التهيئة',
			'userNutZappedYou' => ({required Object name, required Object number}) => '${name} أرسل لك nut zap بقيمة ${number} sats',
			'noteDeletedSuccessfully' => 'تم حذف الملاحظة بنجاح',
			'ecashCreated' => 'تم إنشاء eCash',
			'toMint' => 'إلى Mint',
			'toLightning' => 'إلى Lightning',
			'payOrWithdraw' => 'دفع أو سحب',
			'withdraw' => 'سحب',
			'ecash' => 'Ecash',
