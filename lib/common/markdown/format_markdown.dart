  ...
  static ResultMarkdown convertToMarkdown(
    ...
    switch (type) {
      ...
      case MarkdownType.image:
        changedData =
            '![image${data.substring(fromIndex, toIndex)}](${data.substring(fromIndex, toIndex)})';
        replaceCursorIndex = 1;
      ...
      case MarkdownType.uploadedImage:
        changedData =
            '![image${data.substring(fromIndex, toIndex)}](${link ?? data.substring(fromIndex, toIndex)})';
        replaceCursorIndex = 0;
    }
...
enum MarkdownType {
  ...
  /// support for math equations using katex
  mathEquation,
